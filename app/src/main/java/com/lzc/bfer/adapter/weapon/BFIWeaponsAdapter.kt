...
- @desc:
 */
class BFIWeaponsAdapter(weaponsData: MutableList<BFIWeapon>) : BaseQuickAdapter<BFIWeapon, BaseViewHolder>
    (R.layout.weapon_item, weaponsData) {
    override fun convert(helper: BaseViewHolder, item: BFIWeapon) {
