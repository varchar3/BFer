...
- @desc:
 */
class BFVWeaponsAdapter(weaponsData: MutableList<BFVWeapon>) : BaseQuickAdapter<BFVWeapon, BaseViewHolder>
    (R.layout.weapon_item, weaponsData) {
    override fun convert(helper: BaseViewHolder, item: BFVWeapon) {
        ...
        helper.apply {
            ...
            setText(R.id.tv_kpm, item.killsPerMinute.toString())
